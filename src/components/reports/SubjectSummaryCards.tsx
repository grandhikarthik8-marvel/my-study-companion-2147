  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      <Card className="space-y-1 p-4">
        ...
        <p className="text-xs text-success">{most ? formatStopwatch(most.seconds) : "No data yet"}</p>
      </Card>
      <Card className="space-y-1 p-4">
        ...
        <p className="text-xs text-warning">
          {least ? `Only ${formatStopwatch(least.seconds)} — give it more time` : "Track more subjects"}
        </p>
      </Card>
    </div>
  );
